...
class LectureNote{
    ...
    private $temp;
    private static $uploadDir = 'pdf/quiz';
    private static $uploadRootDir = '%kernel.root_dir%/../pdf/quiz';
    ...
    public function getAbsolutePath()
    {
        return null === $this->id
            ? null
            : self::$uploadRootDir . '/' . $this->id . '/' . $this->id . '.original.pdf';
    }
    ...
    public function getWebPath($type = 'original')
    {
        return null === $this->id
            ? null
            : self::$uploadDir . '/' . $this->id . '/' . $this->id . '.' . $type . '.pdf';
    }
